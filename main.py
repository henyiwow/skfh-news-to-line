...
def normalize_title(title):
    title = re.sub(r'[｜|‧\-－–—~～].*/search?q=台新金控+OR+台新人壽+OR+台新壽+OR+吳東亮&hl=zh-TW&gl=TW&ceid=TW:zh-Hant",
...
if __name__ == "__main__":
    ...
    if news:
        ...
        print("⚠️ 沒有符合條件的新聞，不發送。"), '', title)  # 移除媒體後綴
...
if __name__ == "__main__":
    ...
    if news:
        ...
        print("⚠️ 沒有符合條件的新聞，不發送。")/search?q=台新金控+OR+台新人壽+OR+台新壽+OR+吳東亮&hl=zh-TW&gl=TW&ceid=TW:zh-Hant",
        "https://news.google.com/rss/search?q=壽險+OR+健康險+OR+意外險+OR+人壽&hl=zh-TW&gl=TW&ceid=TW:zh-Hant",
        "https://news.google.com/rss/search?q=金控+OR+金融控股&hl=zh-TW&gl=TW&ceid=TW:zh-Hant",
    ]
